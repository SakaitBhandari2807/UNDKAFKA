...
#
sanitized_topic = app.topic("com.udacity.streams.ClickEventSanitized",value_type=ClickEventSanitized)
...
async def clickevent(clickevents):
    async for clickevent in clickevents:
        ...
        #
        sanitized_obj = ClickEventSanitized(
        ...
        #
        await sanitized_topic.send(key=clickevent.timestamp,value=sanitized_obj)
