...
async def produce(topic_name):
    ...
    #
    # TODO: Create a CachedSchemaRegistryClient. Use SCHEMA_REGISTRY_URL. See:
    #  https://github.com/confluentinc/confluent-kafka-python/blob/master/confluent_kafka/avro
    #  /cached_schema_registry_client.py#L47
    #
    schema_registry = CachedSchemaRegistryClient(SCHEMA_REGISTRY_URL)


    #
    # TODO: Replace with an AvroProducer. See: https://docs.confluent.io/current/clients/confluent-kafka-python/index
    #  .html?highlight=loads#confluent_kafka.avro.AvroProducer
    #
    # p= Producer({"bootstrap.servers": BROKER_URL})
    p = AvroProducer({"bootstrap.servers": BROKER_URL}, schema_registry=schema_registry)
    while True:
        #
        # TODO: Replace with an AvroProducer produce. Make sure to specify the schema! Tip: Make sure to serialize
        #  the ClickEvent with `asdict(ClickEvent())` See:
        #  https://docs.confluent.io/current/clients/confluent-kafka-python/index.html?highlight=loads
